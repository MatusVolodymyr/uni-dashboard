...
from src.metrics import QUESTION_LABELS, ROLE_CONFIG, teacher_summary, top_teachers
...
with st.sidebar:
    ...
    teacher_type = st.radio("Категорія", ["Лектор", "Практик"],
...
tab_top, tab_rank, tab_profile = st.tabs(
    ["🏆 Топ викладачів", "📋 Повний рейтинг", "🔍 Профіль викладача"]
)
